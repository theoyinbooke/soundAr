  ...
  return (
    ...
    <div className="generate-layout">
      <Panel className="composer-panel" ariaLabel="Music generation composer">
        ...
        <div className="selector-grid music-selector-grid">
          <SelectField
            label="Music model"
            value={modelId}
            onChange={setModelId}
          ...
          />
          <div className="field music-render-profile">
        ...
        <div className="waveform-panel">
          ...
          <button className="icon-button preview-play" type="button" aria-label={isPlaying ? "Pause preview" : "Play preview"} title={isPlaying ? "Pause preview" : "Play preview"} disabled={!audioUrl || isAudioLoading} onClick={() => void togglePlayback()}>{isPlaying ? <Pause aria-hidden="true" fill="currentColor" size={13} /> : <Play aria-hidden="true" fill="currentColor" size={13} />}</button>
