...
import { videoSourceForIdlePoster, videoSourceWithFirstFrame } from "./videoPlayback";
...
describe("videoSourceWithFirstFrame", () => {
  ...
  it("keeps the native media URL untouched while a durable poster is present", () => {
    expect(videoSourceForIdlePoster("asset://localhost/master.mp4", "asset://localhost/poster.png")).toBe("asset://localhost/master.mp4");
  });
});
